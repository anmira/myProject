				...
				<form name="updateForm" role="form" method="post" action="/board/update" enctype="multipart/form-data">
					...
					<table>
						<tbody>
							...
							<tr>
								<td>
									<label for="title">국가</label><input type="text" id="country" name="country" value="${update.country}" class="chk" title="국가를 입력하세요." />
								</td>
							</tr>
							<tr>
								<td>
									<label for="title">지역</label><input type="text" id="area" name="area" value="${update.area}" class="chk" title="지역을 입력하세요." />
								</td>
							</tr>
							<tr>
								<td>
									<label for="title">경비</label><input type="text" id="money" name="money" value="${update.money}" class="chk" title="경비를 입력하세요." />
								</td>
							</tr>
							<tr>
								<td>
									<label for="title">기간</label><input type="text" id="period" name="period" value="${update.period}" class="chk" title="기간을 입력하세요." />
								</td>
							</tr>
							<tr>
								<td>
